...
from hbayesdm.preprocess_funcs import pd_preprocess_func

__all__ = ['pd_delta']


class PdDelta(TaskModel):
    ...
    _preprocess_func = pd_preprocess_func
...
def pd_delta(
    ...
    """Prisoner's Dilemma Task - Rescorla-Wagner (Delta) Model

    Hierarchical Bayesian Modeling of the Prisoner's Dilemma Task 
    ...
    **tab-delimited** text file, whose rows represent trial-by-trial observations
    ...
    For the Prisoner's Dilemma Task, there should be 3 columns of data
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('pd_delta').
    ...
    .. code:: python
        ...
        from hbayesdm.models import pd_delta

        # Run the model and store results in "output"
        output = pd_delta(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
